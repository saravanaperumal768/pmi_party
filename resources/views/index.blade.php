...
<!-- Ideology -->
<section class="ideology-area two pt-50 pb-70">
    <div class="container">
        <div class="section-title two">

            <h2>Our Party Leaders</h2>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="ideology-item">
                    <img src="assets/images/leaders/leader2.jpg" alt="Leader" />
                    <div class="bottom">
                        <h3>State General Secretary</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="ideology-item">
                    <img src="assets/images/leaders/leader3.jpg" alt="Leader" />
                    <div class="bottom">
        ...
        <div class="row justify-content-center">
            <div class="col-sm-6 col-lg-3">
                <div class="counter-item">
                    ...
                    <h3>
                        <span class="odometer" data-count="234">00</span>
                    </h3>
                    <p>Districts</p>
                </div>
            </div>
...
<!-- Blog -->
<section class="blog-area two pt-50 pb-70">
    <div class="container">
        <div class="section-title two">
